            ...
            <div className="flex flex-col gap-12">
                ...
                <section className="flex flex-col md:flex-row-reverse gap-12 items-center">
                    <div className="flex-1">
                        ...
                        <p className="text-lg text-muted mb-6 leading-relaxed">Listen to the thunder of the largest waterfall in the world. Our regional connections hub through Johannesburg provide seamless access to this UNESCO World Heritage site.</p>
                             ...
                             {[
                                ...
                                { icon: <Plane size={16}/>, text: 'Daily Direct Flights from Regional Hubs' }
                                 ...
                                 <li key={j} className="flex items-center gap-3 text-white/90">
                                     <div className="text-sky-400">{l.icon}</div> {l.text}
                                 </li>
                             ))}
                        </ul>
                         <button className="btn-primary px-10">Book an Adventure</button>
                    </div>
                    <div className="flex-1 w-full h-[500px] rounded-2xl overflow-hidden glass-panel">
                        <img 
