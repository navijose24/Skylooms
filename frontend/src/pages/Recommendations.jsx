...
const Recommendations = () => {
    ...
    return (
        <div className="container mt-8 animate-slide-up">
            <h1 className="text-4xl text-center text-gradient mb-8">Where to Stay or how to reach!</h1>
            <p className="text-center text-muted mb-8">Personalize your stay and transport for your trip.</p>
            <div className="flex justify-center gap-6 mb-12 animate-slide-up" style={{ animationDelay: '0.1s' }}>
                <button className="btn-ghost px-8 py-3 flex items-center gap-2" onClick={() => navigate('/')}>
                    Back
                </button>
            ...
            <div className="flex flex-col gap-12">
                ...
                <section>
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-3xl flex items-center gap-3 text-main-color"><Hotel color="var(--primary-blue)" /> Hotels</h2>
                        <select
                            className="text-main-color px-4 py-2 rounded-lg outline-none transition-colors border border-[var(--glass-border)]"
                            value={hotelFilter}
                ...
                <section>
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-3xl flex items-center gap-3 text-main-color"><Car color="var(--primary-blue)" /> Transfers</h2>
                        <select
                            className="text-main-color px-4 py-2 rounded-lg outline-none transition-colors border border-[var(--glass-border)]"
                            value={cabFilter}
